...
namespace Phantasma.Blockchain.Contracts
{
    public static class ScriptBuilderExtensions
    {
        ...
        {
            return sb.CallContract(NativeContractKind.Gas.GetName(), "LoanGas", from, gasPrice, gasLimit);
        }
        ...
        {
            return sb.CallContract(NativeContractKind.Gas.GetName(), "AllowGas", from, to, gasPrice, gasLimit);
        }

        public static ScriptBuilder SpendGas(this ScriptBuilder sb, Address address)
        {
            return sb.CallContract(NativeContractKind.Gas.GetName(), "SpendGas", address);
        }

        public static ScriptBuilder MintTokens(this ScriptBuilder sb, string tokenSymbol, Address target, BigInteger amount)
        {
            return sb.CallInterop("Runtime.MintTokens", tokenSymbol, target, amount);
        }
