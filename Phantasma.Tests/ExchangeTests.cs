...
namespace Phantasma.Tests
{
    ...
    public class ExchangeTests
    {
        ...
        public void TestIoCLimitMinimumQuantity()
        {
            ...
            var minimumBaseToken = UnitConversion.ToDecimal(simulator.Nexus.RootChain.InvokeContract(simulator.Nexus.RootChain.Storage, "exchange", "GetMinimumTokenQuantity", buyer.baseToken).AsNumber(), buyer.baseToken.Decimals);
            var minimumQuoteToken = UnitConversion.ToDecimal(simulator.Nexus.RootChain.InvokeContract(simulator.Nexus.RootChain.Storage, "exchange", "GetMinimumTokenQuantity", buyer.quoteToken).AsNumber(), buyer.baseToken.Decimals);
        ...
        class ExchangeUser
        {
            ...
            public decimal OpenLimitOrder(decimal orderSize, decimal orderPrice, ExchangeOrderSide side, bool IoC = false)
            {
                ...
                var startingOppositeOrderbook = (ExchangeOrder[])simulator.Nexus.RootChain.InvokeContract(simulator.Nexus.RootChain.Storage, "exchange", "GetOrderBook", baseSymbol, quoteSymbol, otherSide).ToObject();
                ...
                if (wasNewOrderClosed)
                {
                    ...
                    try
                    {
                        simulator.Nexus.RootChain.InvokeContract(simulator.Nexus.RootChain.Storage, "exchange", "GetExchangeOrder", createdOrderUid);
                ...
                else //if the order was not IoC and it wasn't closed, then:
                {
                    ...
                    try
                    {
                        createdOrderPostFill = (ExchangeOrder)simulator.Nexus.RootChain.InvokeContract(simulator.Nexus.RootChain.Storage, "exchange", "GetExchangeOrder", createdOrderUid).ToObject();
                    }
                    catch (Exception e)
                    {
                ...
                else //if the user order was not closed and it wasnt IoC, it should have the correct unfilled amount
                {
                    ...
                    if (expectedRemainingEscrow == 0)
                    {
                        ...
                        try
                        {
                            ...
                            simulator.Nexus.RootChain.InvokeContract(simulator.Nexus.RootChain.Storage, "exchange", "GetOrderLeftoverEscrow", createdOrderUid);
                    ...
                    {
                        actualRemainingEscrow = simulator.Nexus.RootChain.InvokeContract(simulator.Nexus.RootChain.Storage, "exchange", "GetOrderLeftoverEscrow", createdOrderUid).AsNumber();
                    }
