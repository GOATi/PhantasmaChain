...
using static Phantasma.Contracts.ConsensusContract;
using static Phantasma.Contracts.ValidatorContract;
...
namespace Phantasma.Tests
{
    ...
    public class ConsensusTests
    {
        ...
        private void CreateValidators()
        {
            ...
            for (int i = 2; i < validatorKeyPairs.Length; i++)
            {
                ...
                var validatorType = simulator.Nexus.RootChain
                    .InvokeContract(simulator.Nexus.RootChain.Storage, NativeContractKind.Validator, nameof(ValidatorContract.GetValidatorType),
        ...
        private void AddNewValidator(KeyPair newValidator)
        {
            ...
            var validators = (ValidatorEntry[]) simulator.Nexus.RootChain.InvokeContract(simulator.Nexus.RootChain.Storage, NativeContractKind.Validator,
            ...
            var votingRank = simulator.Nexus.RootChain.InvokeContract(simulator.Nexus.RootChain.Storage, NativeContractKind.Consensus, nameof(ConsensusContract.GetRank), pollName,
            ...
            for (int i = 0; i <= activeValidatorCount; i++)
            {
                ...
                votingRank = simulator.Nexus.RootChain.InvokeContract(simulator.Nexus.RootChain.Storage, NativeContractKind.Consensus, nameof(ConsensusContract.GetRank), pollName, validatorChoice).AsNumber();
